...
<head>
    ...
    <title>Criar conta — Crack Hub</title>
...
<body class="bg-white text-slate-800 antialiased overflow-x-hidden">
    ...
    <main class="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div class="w-full max-w-md bg-white border border-slate-100 rounded-3xl shadow-xl shadow-pink-50 p-8">
            <div class="text-center mb-8">
                <img src="{{ asset('images/logocrackhub.png') }}" class="w-14 h-14 mx-auto rounded-xl mb-4" alt="Logo">
                <h1 class="text-3xl font-extrabold text-slate-900">Criar conta</h1>
                <p class="text-slate-500 mt-2">Comece a usar o Crack Hub gratuitamente.</p>
            </div>
